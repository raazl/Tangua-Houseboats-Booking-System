import BlogBoat from "../assets/images/BlogBoat.jpg";
import BlogBoat1 from "../assets/images/BlogBoat1.jpg";
import BlogBoat2 from "../assets/images/BlogBoat2.jpg";

/**
 * Defines a list of blog posts with full content.
 * Each post includes an ID, title, excerpt, and the full content.
 * @type {Array<Object>}
 */
export const blogPosts = [
    ...
    },
    {
        ...
        title: "Your Guide to Houseboat Adventures",
        excerpt: "Tips and tricks for making the most of your houseboat trip, from packing essentials to local attractions.",
        content: `
            <p>Embarking on a houseboat adventure is an exciting prospect, and with a little preparation, you can make it truly unforgettable. Here are some tips to help you make the most of your trip:</p>
            <h3>Packing Essentials:</h3>
            <ul>
                <li>Lightweight clothing suitable for warm weather.</li>
                <li>Sunscreen, hats, and sunglasses for sun protection.</li>
                <li>Insect repellent to ward off mosquitoes.</li>
                <li>Binoculars for birdwatching and wildlife spotting.</li>
                <li>Camera to capture the stunning landscapes.</li>
                <li>Personal medications and a basic first-aid kit.</li>
            </ul>
            <h3>Onboard Activities:</h3>
            <p>Our houseboats offer a range of activities to keep you entertained. Enjoy fishing, kayaking, or simply relaxing on the deck with a good book. Our crew can also arrange cultural performances or local village visits upon request.</p>
            <h3>Local Cuisine:</h3>
    ...
    },
    {
        ...
        title: "The Best Time to Visit Tangua Haor",
        excerpt: "Learn about the seasonal changes and find out when is the ideal time to embark on your Tangua houseboat journey.",
        content: `
            <p>Tangua Haor transforms with the seasons, each offering a unique charm. Choosing the best time to visit depends on your preferences and what you wish to experience:</p>
            <h3>Monsoon (June to September):</h3>
            <p>During the monsoon season, the haor is at its fullest, with vast expanses of water creating a mesmerizing landscape. This is the ideal time for cruising and exploring the submerged villages. The lush greenery and vibrant ecosystem are at their peak, offering incredible opportunities for nature photography.</p>
            <h3>Post-Monsoon (October to November):</h3>
            <p>The water levels gradually recede, revealing new landscapes and making it easier to explore the surrounding areas. The weather is pleasant, and the migratory birds begin to arrive, making it a great time for birdwatching.</p>
